 ...
 * `ScopeBar`, on its own row below: the reviewer has to be able to tell a diff
 * scoped to one commit from the whole pull request at a glance, and a toggle
 * among the other actions up here was not that.
 */
